...
/**
 * Default keybindings that match current xccodex behavior.
...
export const DEFAULT_BINDINGS: KeybindingBlock[] = [
  ...
  },
  {
    ...
    bindings: {
      ...
      // â€?null-unbinding space hits a pre-existing useKeybinding.ts trap
  ...
  },
  {
    ...
    bindings: {
      ...
      'ctrl+n': 'select:next',
      // Toggle/activate the selected setting (space only â€?enter saves & closes)
      space: 'select:accept',
  ...
  },
  {
    ...
    bindings: {
      ...
      // q â€?pager convention (less, tmux copy-mode). Transcript is a modal
  ...
  },
  {
    ...
    bindings: {
      ...
      // modifier actually reaches the pty â€?inert elsewhere.
  ...
  // PromptInput unmounts while cursor active â€?no key conflict.
  ...(feature('MESSAGE_ACTIONS')
    ? [
        {
          ...
          bindings: {
            ...
            // meta = cmd on macOS; super for kitty keyboard-protocol â€?bind both.
            ...
            // Mouse selection extends on shift+arrow (ScrollKeybindingHandler:573) when present â€?            // correct layered UX: esc clears selection, then shift+â†?jumps.
            ...
            // Mirror MESSAGE_ACTIONS. Not imported â€?would pull React/ink into this config module.
