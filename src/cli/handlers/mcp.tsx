/**
 * MCP subcommand handlers â€?extracted from main.tsx for lazy loading.
...
// mcp add-from-claude-desktop (lines 4881â€?927)
...
// mcp reset-project-choices (lines 4935â€?952)
export async function mcpResetChoicesHandler(): Promise<void> {
  ...
  cliOk('All project-scoped (.mcp.json) server approvals and rejections have been reset.\n' + 'You will be prompted for approval next time you start xccodex.');
}
