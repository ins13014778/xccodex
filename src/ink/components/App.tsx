...
export default class App extends PureComponent<Props, State> {
  ...
  handleSetRawMode = (isEnabled: boolean): void => {
    ...
    if (isEnabled) {
      ...
      if (this.rawModeEnabledCount === 0) {
        ...
        // push (CSI >1u) and xterm modifyOtherKeys level 2 (CSI >4;2m) â€?        // terminals honor whichever they implement (tmux only accepts the
        // latter).
  ...
  handleSuspend = (): void => {
    ...
    // Emit suspend event for xccodex to handle. Mostly just has a notification
    ...
    const resumeHandler = () => {
      ...
      // Emit resume event for xccodex to handle
