...
export const DESCRIPTION = 'Get or set xccodex configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set xccodex configuration settings.

  View or change xccodex settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
