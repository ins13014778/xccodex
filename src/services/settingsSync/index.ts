...
import {
  getEffectiveSettingsFilePathForSource,
...
async function buildEntriesFromLocalFiles(
  ...
  const userSettingsPath = getEffectiveSettingsFilePathForSource('userSettings')
  if (userSettingsPath) {
  ...
  if (projectId) {
    ...
    const localSettingsPath =
      getEffectiveSettingsFilePathForSource('localSettings')
