...
export function hookSourceDescriptionDisplayString(source: HookSource): string {
  switch (source) {
    case 'userSettings':
      return 'User settings (~/.xccode/settings.json)'
    case 'projectSettings':
      return 'Project settings (.xccode/settings.json)'
    case 'localSettings':
      return 'Local settings (.xccode/settings.local.json)'
    case 'pluginHook':
      ...
      return 'Plugin hooks (~/.xccode/plugins/*/hooks/hooks.json)'
    case 'sessionHook':
      return 'Session hooks (in-memory, temporary)'
    case 'builtinHook':
      return 'Built-in hooks (registered internally by xccode)'
    default:
